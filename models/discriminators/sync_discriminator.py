...
from models.layers.conv_layers import Conv1dBlock,Conv2dBlock
...
class SyncDiscriminator(BaseModel):
    ...
    def execute(self, audio_frames, video_frames):
        ...
        video_embeddings = jt.squeeze(video_embeddings,dim=2)#B,C,F=1,H,W ==> B,C,H,W
        ...
        audio_embeddings = jt.normalize(audio_embeddings,p=2,dim=1)
        video_embeddings = jt.normalize(video_embeddings,p=2,dim=1)
        cosine_dist = jt.cosine_similarity(audio_embeddings,video_embeddings)
